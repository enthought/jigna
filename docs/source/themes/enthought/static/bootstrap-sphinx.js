(function () {
  ...
  /**
  * Patch all aside (.sidebar) blocks to remove class ``sidebar`` and add Bootstrap
  * classes ``alert alert-info span4 pull-right``.
  */
  var patchAsides = function() {
    $(".sidebar")
      .removeClass("sidebar")
      .addClass("alert alert-info span4 pull-right")
  }

...
class TestJignaWebSync(TestJignaQt):
    ...
    def setUpClass(cls, async=False):
        ...
        # Recent Firefox releases do not seem to work with Selenium so we
        # switch to Chrome on darwin but continue with FF on travis.
        # See: https://github.com/seleniumhq/selenium/issues/1851
